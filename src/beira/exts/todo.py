...
class TodoCompleteButton(discord.ui.Button[TodoViewABC]):
    ...
    **kwargs
    ...
    async def callback(self, interaction: beira.Interaction) -> None:  # type: ignore # Necessary narrowing
...
class TodoView(TodoViewABC):
    ...
    **kwargs
    ...
    async def update_todo(self, interaction: beira.Interaction, updated_item: TodoItem) -> None:
...
class TodoCog(commands.Cog, name="Todo"):
    ...
    @todo.command("add")
    async def todo_add(self, ctx: beira.Context, content: str) -> None:
    ...
    @todo.command("delete")
    async def todo_delete(self, ctx: beira.Context, todo_id: int) -> None:
    ...
    @todo.command("clear")
    async def todo_clear(self, ctx: beira.Context) -> None:
    ...
    @todo.command("show")
    async def todo_show(self, ctx: beira.Context, todo_id: int) -> None:
    ...
    @todo.command("list")
    async def todo_list(self, ctx: beira.Context, complete: bool = False, pending: bool = True) -> None:
