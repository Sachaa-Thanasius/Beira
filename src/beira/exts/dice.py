...
import beira
from beira.utils import EMOJI_STOCK
...
class DiceView(ui.View):
    ...
    async def set_modifier(self, interaction: beira.Interaction, button: ui.Button[Self]) -> None:
    ...
    async def set_number(self, interaction: beira.Interaction, button: ui.Button[Self]) -> None:
    ...
    async def set_expression(self, interaction: beira.Interaction, _: ui.Button[Self]) -> None:
...
async def roll(ctx: beira.Context, expression: str | None = None) -> None:
