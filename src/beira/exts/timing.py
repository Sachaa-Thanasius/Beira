...
class TimingCog(commands.Cog, name="Timing"):
    ...
    async def timezone_(self, ctx: beira.Context) -> None:
    ...
    async def timezone_set(self, ctx: beira.Context, tz: str) -> None:
        """Set your timezone.
    ...
    async def timezone_clear(self, ctx: beira.Context) -> None:
        """Clear your timezone."""
    ...
    async def timezone_info(self, ctx: beira.Context, tz: str) -> None:
        try:
            zone = ZoneInfo(tz)
        except ZoneInfoNotFoundError:
            await ctx.send("That's an invalid time zone.")
