...
class UpdateOPGGView(discord.ui.View):
    ...
    async def update(self, interaction: beira.Interaction, button: discord.ui.Button[Self]) -> None:
...
class LoLCog(commands.Cog, name="League of Legends"):
    ...
    @lol.command("stats")
    async def lol_stats(self, ctx: beira.Context, summoner_name: str) -> None:
    ...
    async def lol_leaderboard(self, ctx: beira.Context, *, summoner_names: str | None = None) -> None:
