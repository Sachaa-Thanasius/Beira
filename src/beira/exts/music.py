...
import beira
from beira.utils import EMOJI_STOCK, PaginatedEmbedView
...
class MusicCog(commands.Cog, name="Music"):
    ...
    @commands.guild_only()
    async def music(self, ctx: beira.GuildContext) -> None:
    ...
    @music.command()
    async def play(self, ctx: beira.GuildContext, query: str, _channel: discord.VoiceChannel | None = None) -> None:
    ...
    @play.before_invoke
    async def play_ensure_voice(self, ctx: beira.GuildContext) -> None:
    ...
    @music.command()
    @beira.in_bot_vc()
    async def pause(self, ctx: beira.GuildContext) -> None:
        """Pause the audio."""
    ...
    @music.command()
    @beira.in_bot_vc()
    async def resume(self, ctx: beira.GuildContext) -> None:
    ...
    @beira.in_bot_vc()
    async def stop(self, ctx: beira.GuildContext) -> None:
    ...
    @music.command()
    async def current(self, ctx: beira.GuildContext) -> None:
    ...
    @queue.command()
    @beira.in_bot_vc()
    async def remove(self, ctx: beira.GuildContext, entry: int) -> None:
    ...
    @queue.command()
    @beira.in_bot_vc()
    async def clear(self, ctx: beira.GuildContext) -> None:
        """Empty the queue."""
    ...
    @music.command()
    @beira.in_bot_vc()
    async def move(self, ctx: beira.GuildContext, before: int, after: int) -> None:
    ...
    @music.command()
    @beira.in_bot_vc()
    async def skip(self, ctx: beira.GuildContext, index: int = 1) -> None:
    ...
    @music.command()
    @beira.in_bot_vc()
    async def shuffle(self, ctx: beira.GuildContext) -> None:
    ...
    @music.command()
    @beira.in_bot_vc()
    async def loop(self, ctx: beira.GuildContext, loop: Literal["All Tracks", "Current Track", "Off"] = "Off") -> None:
    ...
    @music.command()
    @beira.in_bot_vc()
    async def volume(self, ctx: beira.GuildContext, volume: int | None = None) -> None:
    ...
    @beira.in_bot_vc()
    async def muse_filter(self, ctx: beira.GuildContext, name: str) -> None:
    ...
    async def muse_filter_name_autocomplete(self, _: beira.Interaction, current: str) -> list[app_commands.Choice[str]]:
        return [
    ...
    @commands.guild_only()
    @beira.in_bot_vc()
    async def muse_export(self, ctx: beira.GuildContext) -> None:
    ...
    @commands.guild_only()
    async def muse_import(self, ctx: beira.GuildContext, import_file: discord.Attachment) -> None:
    ...
    @muse_import.error
    async def muse_import_error(self, ctx: beira.Context, error: commands.CommandError) -> None:
