...
import beira
from beira.utils import EMOJI_URL, html_to_markdown
...
class FandomWikiSearchCog(commands.Cog, name="Fandom Wiki Search"):
    ...
    async def wiki(self, ctx: beira.Context, wiki: str, search_term: str) -> None:
    ...
    async def wiki_autocomplete(self, _: beira.Interaction, current: str) -> list[app_commands.Choice[str]]:
